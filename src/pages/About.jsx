  ...
  return (
    <div className="min-h-screen w-3/4 flex items-center flex-col pt-28 mb-24">
      ...
      <h2 className=" w-full font-semibold mt-5 text-xl text-wrap p-2  text-gray-800 text-center">
        YummyHub - Reacting to Your Hunger, One Byte at a Time! 🌶️
      </h2>
      ...
      <p className="paragraph">
        Welcome to YummyHub, a culinary haven where cutting-edge technology
        meets a world of flavors. At YummyHub, we go beyond being just a food
      ...
      <p className="paragraph">
        YummyHub is built on a foundation of the latest and most robust
      ...
      <p className="paragraph">
        YummyHub is more than a food delivery platform; it's a culinary
      ...
      <h1 className="headingOne">Join the YummyHub Experience 🎉</h1>
      <p className="paragraph">
        At YummyHub, we're not just delivering food; we're delivering an
        ...
        Indulge in the best of both worlds - YummyHub, where technology meets
